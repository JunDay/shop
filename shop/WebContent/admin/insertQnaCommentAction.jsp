...
<%
	...
	System.out.println("+[Debug] \"Started\" | insertQnaCommentAction.jsp");
	...
	if(loginMember == null || loginMember.getMemberLevel() < 1){
		...
		System.out.println("-[Debug] \"CAN NOT FIND Session information\" | insertQnaCommentAction.jsp");
		return;
	}
	...
	qnaComment.setMemberName(request.getParameter("memberName"));
	
	System.out.println(" [Debug] orderNo : \"" + qnaComment.toString() + "\" | insertQnaCommentAction.jsp");
