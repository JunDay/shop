...
<div class="container">
	...
	<table class="table table-striped">
		...
		<tr>
			<td><%=qnaComment.getMemberName()%></td>
			<td width="50%"><%=qnaComment.getQnaCommentContent()%></td>
			<td><%=qnaComment.getCreateDate()%></td>
			<td><a class="btn btn-warning" href="<%=request.getContextPath()%>/admin/updateQnaCommentForm.jsp?=<%=qna.getQnaNo()%>">수정</a></td>
		</tr>
	</table>
